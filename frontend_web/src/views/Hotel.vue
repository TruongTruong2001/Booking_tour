...
export default {
   ...
   methods: {
      getdata(names) {
         this.$emit('getclickedItem', names);
      },
      async retrieveHotel() {
         try {
...
<template>
   <div>
               ...
               <div class="product-items">
                  <div class="val">
                        ...
                        <div class="product-item-text">
                           <div class="image">
                              ...
                              <div class="city">
                                 <a href="">
                                    <span class="txt"
                                       ><img src="@/assets/images/way.png" alt="" /> Thành Phố: {{ item.area }}</span
                                    >
                                 </a>
                              </div>
                           </div>
                     ...
                     <div class="cartadd">
                        ...
                        >
                           <button type="button" class="btn btn-outline-dark" @click="nextdetailsproduct">
                              Chi tiết
                           </button>
                        </router-link>
                        <span class="price">{{
      ...
      <div id="products" class="box">
         <div class="main-heading">
            <p class="heading">Top địa điểm đang thịnh hành</p>
            <p class="heading1">Top những nơi nổi bật mới nhất nên khám phá</p>
         </div>
