        ...
        <div class="product-list">
            ...
            <div
               ...
               :key="item._id"
                ...
                v-show="item.destination === 'Bạc Liêu'"
             >
                        ...
                        <div class="product-item-text">
                               ...
                               <a>  
                                    ...
                                    <h1> {{ item.title }} </h1>
                                        <span class="txt">
                                            ...
                                            Thời gian: <strong> {{ item.time }}</strong>
                                            </span>
                         ...
                         <div class="cartadd">
                                ...
                                <router-link :to="{
                                    ...
                                    <button type="button" class="btn btn-outline-dark" @click="nextdetailsproduct">Đặt tour</button>
                                </router-link>
                         </div>
